...
public class SendMailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String todoSubject = intent.getStringExtra("titleValue");
        String todoDescription = intent.getStringExtra("descriptionValue");
        mEditTextSubject.setText(todoSubject);
        mEditTextMessage.setText(todoDescription);
